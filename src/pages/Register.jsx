...
export default function Register() {
  ...
  const inp = 'w-full pl-10 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none';
  ...
  return (
    <div className="px-4 pt-6 pb-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button type="submit" disabled={loading}
          ...
          className={`w-full py-4 rounded-xl font-bold text-base transition-colors
            ${loading ? 'bg-gray-300 text-gray-500' : 'bg-green-600 text-white active:bg-green-700'}`}>
      ...
      <div className="text-center mt-5">
        ...
        <Link to="/login" className="text-blue-600 font-semibold text-sm" onClick={() => haptic('light')}>
          Kiring
        </Link>
      </div>
    </div>
